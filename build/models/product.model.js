...
var ProductModel = /** @class */ (function () {
    ...
    ProductModel.prototype.create = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var conncection, query, result, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conncection.query(query, [product.name, product.price])];
                    case 2:
                        result = _a.sent();
                        //release conncetion
                        conncection.release();
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Cannot Create Product: ".concat(product.name, " because ").concat(err_1.message));
    ...
    //list
    ProductModel.prototype.list = function () {
        return __awaiter(this, void 0, void 0, function () {
            var conncection, query, result, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Cannot Return Products because ".concat(err_2.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    //get specific
    ProductModel.prototype.getProduct = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var conncection, query, result, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Cannot Find Product ".concat(id, " because ").concat(err_3.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    ProductModel.prototype.deleteProduct = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var conncection, query, result, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
