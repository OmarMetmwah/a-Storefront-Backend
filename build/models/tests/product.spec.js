...
describe('Product Model', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(createdProduct).toEqual(__assign({ id: createdProduct.id }, product));
                    return [4 /*yield*/, productModel.deleteProduct(createdProduct.id)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('index method should return a list of products', function () { return __awaiter(void 0, void 0, void 0, function () {
        var createdProduct, productList;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, productModel.create(product)];
                case 1:
    ...
    it('show method should return the correct product', function () { return __awaiter(void 0, void 0, void 0, function () {
        var createdProduct, productFromDb;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, productModel.create(product)];
                case 1:
                    createdProduct = _a.sent();
                    return [4 /*yield*/, productModel.getProduct(createdProduct.id)];
                case 2:
    ...
    it('update method should update the product', function () { return __awaiter(void 0, void 0, void 0, function () {
        var createdProduct, newProductData, _a, name, price;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, productModel.updateProduct(createdProduct.id, newProductData)];
                case 2:
                    _a = _b.sent(), name = _a.name, price = _a.price;
