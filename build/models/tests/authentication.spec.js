...
describe('Authentication Module', function () {
    ...
    describe('Test Authentication Logic', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        expect(authenticatedUser === null || authenticatedUser === void 0 ? void 0 : authenticatedUser.firstname).toBe(user.firstname);
                        expect(authenticatedUser === null || authenticatedUser === void 0 ? void 0 : authenticatedUser.lastname).toBe(user.lastname);
                        return [2 /*return*/];
                }
            });
        }); });
        it('Authenticate method should return null for wrong credentials', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, userModel.authenticate('fake@email.com', 'fakepassword')];
                    case 1:
                        authenticatedUser = _a.sent();
