...
describe('Authentication Module', () => {
	...
	describe('Test Authentication Logic', () => {
		...
		it('Authenticate method should return the authenticated user', async () => {
			const authenticatedUser = await userModel.authenticate(user.username, user.password as string);
		...
		it('Authenticate method should return null for wrong credentials', async () => {
			const authenticatedUser = await userModel.authenticate('fake@email.com', 'fakepassword');
